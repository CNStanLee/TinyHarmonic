...
out_add1_e5_v2     = make_node("Add", inputs=["fifth_dql1","fifth_dql2"], outputs=["c_t_carry"], name="out_add1_e5_v2")
#Branch that gives the output
...
#Branch that carries it forward
quant_linear3_e5_v2 = make_node("QuantizeLinear", inputs=["c_t_carry","scale_9","zero_point_all"], outputs=["c_t_carry_ql"], name="quant_linear3_e5_v2")
...
#Branch that carries it forward
el_mul_node1_e6_v2 = make_node("Mul", inputs=["sixth_dql1","o_t_dql2"], outputs=["h_t_inter_carry"], name="el_mul_node1_e6_v2")#h_t_inter : Curent Hidden State output
#Branch that gives the output
...
#Branch that carries it forward
ql_hidden_state_v2 = make_node("QuantizeLinear", inputs=["h_t_inter_carry","scale_11","zero_point_all"], outputs=["ql_hidden_out_carry"],name="ql_hidden_state_v2")
...
clp_w_fc1 = make_node("Clip", inputs=["weights_fc1_ql","min_6b","max_6b"], outputs=["clp_w_fc1"], name="clp_w_fc1")
...
clp_w_fc2 = make_node("Clip", inputs=["weights_fc2_ql","min_6b","max_6b"], outputs=["clp_w_fc2"], name="clp_w_fc2")
...
clp_w_fc3 = make_node("Clip", inputs=["weights_fc3_ql","min_6b","max_6b"], outputs=["clp_w_fc3"], name="clp_w_fc3")
...
ids_model_brevitas_export_load = onnx.load("./lstm_relu_two_lookback_model_brevitas_export.onnx")
...
lstm_scan = make_graph(
    ...
    outputs = [out_sigmoid,out_hidden_state_float,out_cell_state],
    value_info=[
            ...
            make_tensor_value_info("c_t_carry", onnx.TensorProto.FLOAT, [hidden_size,1]),
            ...
            make_tensor_value_info("h_t_inter_carry", onnx.TensorProto.FLOAT, [hidden_size,1]),
            ...
            make_tensor_value_info("weights_fc1_ql",onnx.TensorProto.INT8, [128,20]),
            make_tensor_value_info("clp_w_fc1",onnx.TensorProto.INT8, [128,20]),    
            make_tensor_value_info("weights_fc1_dql",onnx.TensorProto.FLOAT, [128,20]),
            make_tensor_value_info("out_matmul_fc1",onnx.TensorProto.FLOAT, [128,1]),
            make_tensor_value_info("out_add_fc1",onnx.TensorProto.FLOAT, [128,1]),

            #Dense Layer 2
            make_tensor_value_info("output_relu2",onnx.TensorProto.FLOAT, [128,1]),
            make_tensor_value_info("relu_ql2",onnx.TensorProto.UINT8, [128,1]),
            make_tensor_value_info("relu_dql2",onnx.TensorProto.FLOAT, [128,1]),
            make_tensor_value_info("weights_fc2_ql",onnx.TensorProto.INT8, [64,128]),
            make_tensor_value_info("clp_w_fc2",onnx.TensorProto.INT8, [64,128]),    
            make_tensor_value_info("weights_fc2_dql",onnx.TensorProto.FLOAT, [64,128]),
            make_tensor_value_info("out_matmul_fc2",onnx.TensorProto.FLOAT, [64,1]),
            make_tensor_value_info("out_add_fc2",onnx.TensorProto.FLOAT, [64,1]),

            #Dense Layer 3
            make_tensor_value_info("output_relu3",onnx.TensorProto.FLOAT, [64,1]),
            make_tensor_value_info("relu_ql3",onnx.TensorProto.UINT8, [64,1]),
            make_tensor_value_info("relu_dql3",onnx.TensorProto.FLOAT, [64,1]),
            make_tensor_value_info("weights_fc3_ql",onnx.TensorProto.INT8, [1,64]),
            make_tensor_value_info("clp_w_fc3",onnx.TensorProto.INT8, [1,64]),    
            make_tensor_value_info("weights_fc3_dql",onnx.TensorProto.FLOAT, [1,64]),
            make_tensor_value_info("out_matmul_fc3",onnx.TensorProto.FLOAT, [1,1]),
            make_tensor_value_info("out_add_fc3",onnx.TensorProto.FLOAT, [1,1]),
    ...
    initializer=[
               ...
               #   make_tensor('scale_all',onnx.TensorProto.FLOAT,[],[1]),
                 ...
                 make_tensor('weights_fc1',onnx.TensorProto.FLOAT,[128,20],(weights_fc1_val)),
                 make_tensor('weights_fc2',onnx.TensorProto.FLOAT,[64,128],(weights_fc2_val)),
                 make_tensor('weights_fc3',onnx.TensorProto.FLOAT,[1,64],(weights_fc3_val)),   
                 #fc1
                 ...
                 make_tensor('bias_fc1',onnx.TensorProto.FLOAT,[128,1],(bias_fc1_val)),
                 #fc2
                 ...
                 make_tensor('bias_fc2',onnx.TensorProto.FLOAT,[64,1],(bias_fc2_val)),
                 #fc3
...
onnx.save(onnx_model, './onnx_definiton_of_brevitas_lookback_export.onnx')
