...
def create_real_current_datasets(config, shuffle=True, train_ratio=0.7, val_ratio=0.1, 
...
def init_current_dataloaders(config, batch_size=32, shuffle=True, train_ratio=0.7, 
                            val_ratio=0.1, test_ratio=0.2, input_cycle_fraction=0.5):
    """
    初始化电流数据加载器
    """
    datasets = create_real_current_datasets(
